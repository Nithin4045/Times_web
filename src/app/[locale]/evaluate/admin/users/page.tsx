...
const Users: React.FC = () => {
  ...
  return (
    <div>
      <Flex justify="space-between" align="center" className="mb-5 mr-5">
  <Title level={4} className="pl-15 pt-10 mt-5" style={{ marginBottom: 0,marginTop:'40px' }}>
    <span className="user" style={{ color: 'Black', lineHeight: '3.4' }}>MANAGE USERS</span>
  </Title>
  <Flex align="center" gap={6} style={{marginTop:'60px' }}>
    <Button type="primary" className='primary-btn' onClick={() => setModalVisible(true)}>
      Add User
    </Button>
    ...
    <Upload {...props}>
      <Button type="primary" icon={<UploadOutlined />} style={{ backgroundColor: '#8356a9', color:'white'}}>Upload Users</Button>
    </Upload>
  </Flex>
</Flex>
